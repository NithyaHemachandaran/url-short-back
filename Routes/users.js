...
router.post("/signup", async (req, res) => {
    try {
      ...
      const link = `https://willowy-blini-552309.netlify.app/activate/${hashedUser._id}?activateToken=${token}`;
  ...
  router.post("/activation", async (req, res) => {
    try {
      ...
      //generate token to activate account 
        ...
        const link = `https://willowy-blini-552309.netlify.app/activate/${user._id}?activateToken=${token}`;
...
router.post("/forgot-password", async(req, res) => {
    try {
        ...
        const link = `https://willowy-blini-552309.netlify.app/authorize/?id=${user._id}&token=${token}`;
